...
class MenuPeliculasActivity : AppCompatActivity(){
    ...
    fun cargarPeliculas(){
        ...
        //Lista de peliculas
        peliculasLista.add(Pelicula("1917", R.drawable.milnovecientos,R.drawable.milnovecientosheader,"British trenches somewhere in France. World war has been going on for the third year, heroic illusions have dissipated; general mood - boredom and fatigue. Stuff the belly, sleep, return home to Christmas Eve. On another quiet day, when nothing happens, two young soldiers, Blake and Schofield, are summoned to the general, who instructs them to send an important message to Colonel MacKenzie in the Second Devonshire Battalion, whose telephone connection was cut off by the enemy."))
        peliculasLista.add(Pelicula("Big Hero 6", R.drawable.bighero,R.drawable.headerbighero6,"When a devastating event befalls the city of San Fransokyo and catapults Hiro into the midst of danger, he turns to Baymax and his close friends adrenaline junkie Go Go Tomago, neatnik Wasabi, chemistry whiz Honey Lemon and fanboy Fred. Determined to uncover the mystery, Hiro transforms his friends into a band of high-tech heroes called Big Hero 6."))
...
class PeliculaAdapter: BaseAdapter {
    ...
    override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
        ...
        vista.iv_imgPelicula.setImageResource(pelicula.image)
        vista.tittlePelicula.setText(pelicula.titulo)

        vista.iv_imgPelicula.setOnClickListener(){
